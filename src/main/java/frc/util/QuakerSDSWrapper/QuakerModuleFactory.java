...
public class QuakerModuleFactory<DriveConfiguration, SteerConfiguration> {
    private final ModuleConfiguration moduleConfiguration;
    private final QuakerDriveFactory<?, DriveConfiguration> driveControllerFactory;
    private final QuakerSteerFactory<?, SteerConfiguration> steerControllerFactory;

    public QuakerModuleFactory(ModuleConfiguration moduleConfiguration,
        QuakerDriveFactory<?, DriveConfiguration> driveControllerFactory,
        QuakerSteerFactory<?, SteerConfiguration> steerControllerFactory) {
    ...
    private static class ModuleImplementation implements SwerveModule {
        ...
        private ModuleImplementation(DriveController driveController, SteerController steerContainer) {
            this.driveController = driveController;
            this.steerController = steerContainer;
        }
