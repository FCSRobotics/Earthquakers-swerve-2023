...
public final class QuakerSteerFactoryBuilder {
    // PID configuration
    ...
    public QuakerSteerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public QuakerSteerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public QuakerSteerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    public <T> QuakerSteerFactory<ControllerImplementation, NeoSteerConfiguration<T>> build(AbsoluteEncoderFactory<T> encoderFactory) {
        return new FactoryImplementation<>(encoderFactory);
    }

    public class FactoryImplementation<T> implements QuakerSteerFactory<ControllerImplementation, NeoSteerConfiguration<T>> {
        ...
        public void addDashboardEntries(ShuffleboardContainer container, ControllerImplementation controller) {
            QuakerSteerFactory.super.addDashboardEntries(container, controller);
