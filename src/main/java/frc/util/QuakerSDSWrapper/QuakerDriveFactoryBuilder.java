...
public final class QuakerDriveFactoryBuilder {
    private double nominalVoltage = Double.NaN;
    private double currentLimit = Double.NaN;

    public QuakerDriveFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public QuakerDriveFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    public QuakerDriveFactory<ControllerImplementation, Integer> build() {
        return new FactoryImplementation();
    }

    private class FactoryImplementation implements QuakerDriveFactory<ControllerImplementation, Integer> {
        @Override
